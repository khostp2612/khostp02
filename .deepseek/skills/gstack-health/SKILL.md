...
Read DEEPSEEK.md and look for a `## Health Stack` section. If found, parse the tools
...
A) Looks right -- persist to DEEPSEEK.md and continue
...
3. **Respect DEEPSEEK.md.** If `## Health Stack` is configured, use those exact commands. Do not second-guess.
