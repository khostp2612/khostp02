...
```bash
$GSTACK_ROOT/bin/gstack-brain-init
$GSTACK_ROOT/bin/gstack-config set gbrain_sync_mode artifacts-only
# or "full" if user picked yes-full
```

---

## Step 8: Persist `## GBrain Configuration` in DEEPSEEK.md

Find-and-replace (or append) this section in DEEPSEEK.md:
...
- **DEEPSEEK.md is the audit trail.** Always update it in Step 8 after a
  successful setup.
