...
_EXT_PATH=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT/.deepseek/skills/gstack/extension/manifest.json" ] && _EXT_PATH="$_ROOT/.deepseek/skills/gstack/extension"
[ -z "$_EXT_PATH" ] && [ -f "$HOME/.deepseek/skills/gstack/extension/manifest.json" ] && _EXT_PATH="$HOME/.deepseek/skills/gstack/extension"
