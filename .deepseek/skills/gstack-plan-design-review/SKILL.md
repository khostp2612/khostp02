...
- DEEPSEEK.md — project conventions
...
In that case, show each variant inline using the file reader (so the user can see them),
...
Show the mockup to the user via the file reader. This makes the gap between
